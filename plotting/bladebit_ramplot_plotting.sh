#!/bin/bash
###############################################################################
# Script Name:       bladebit_ramplot_plotting.sh
# Description:       This script runs BladeBit ram plotting for the Chia
...
#
# Usage:             ./bladebit_ramplot_plotting.sh
#
# Requirements:
#   - BladeBit source code and at least 416 GiB of RAM
#   - sudo access
...
#
# Notes:
#   - Adapt disk name, keys, and directories (e.g. TMP_DIR, PLOT_DIR) to your setup
...
START_TIME=$(date +%s)
sudo-g5k /tmp/bladebit-build/bladebit -f "$FARMER_KEY" -p "$POOL_KEY" -n 17 -z 5 ramplot "$PLOT_DIR" &
PLOT_PID=$!
